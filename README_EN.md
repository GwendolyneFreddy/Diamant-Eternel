...
<em>If you've previously installed the mod, remove it before extracting the new version. To do this, run <strong>setup-diamant_eternel.exe</strong>, uninstall all previously installed components and delete the diamant_eternel folder.</em>
