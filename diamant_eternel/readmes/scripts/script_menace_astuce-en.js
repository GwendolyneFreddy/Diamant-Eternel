	...
	[
		...
		"New creature animations: unicorns, horses, fiends, gargoyles...",
		...
		"Undead knights whose behavior is still so inflexible in the Hereafter.",
		"New divine and arcane spells.",
		"New items.",
		"Food ready-to-eat or needed for cooking.",
		"An Alchemy set to create potions and miscellaneous items...",
	];
